...
private:
    ...
    void fillMultipler2();
    U8 getMultipler2Scale(U8 code);
    U8 getDividerScale(U8 code);

    void getMultCxMode0(float FD, U8& C4, U8& C5);
    void getMultCxMode1(float FD, U8& C4, U8& C5);
    void getMultCxMode2(float FD, U8& C4, U8& C5);

    void getDivDxMode0(float FD, U8& D1, U8& D2);
    void getDivDxMode1(float FD, U8& D1, U8& D2);
    void getDivDxMode2(float FD, U8& D1, U8& D2);
