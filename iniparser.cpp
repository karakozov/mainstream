...
{
    fprintf(stderr, " \n");
    fprintf(stderr, "fpgaNumber:        0x%x\n", param.fpgaNumber);
...
{
    fprintf(stderr, "\nAC_SYNC\n");
    fprintf(stderr, "sync_mode:         0x%x\n", param.sync_mode);
    fprintf(stderr, "sync_fd:           %f MHz\n", param.sync_fd);
    fprintf(stderr, "sync_fo:           %f MHz\n", param.sync_fo);
    fprintf(stderr, "sync_selclkout:    0x%x\n", param.sync_selclkout);
    fprintf(stderr, " \n");
}
